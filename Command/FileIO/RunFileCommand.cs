...
namespace kOS
{
    [AttributeCommand(@"^RUN ([a-zA-Z0-9\-_]+?)( ?\((.*?)\))?$")]
    public class RunFileCommand : Command
    {
        public RunFileCommand(Match regexMatch, ExecutionContext context) : base(regexMatch, context) { }
